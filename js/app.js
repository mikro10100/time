 ...
 */
    ...
    (() => {
        ...
        const flsModules = {};
        var modules_images = [ {
            src: "img/body/up/1.jpg",
            title: "слайд 1"
        }, {
            src: "img/body/up/2.jpg",
            title: "слайд 2"
        }, {
            src: "img/body/up/3.jpg",
            title: "слайд 3"
        } ];
        var currentIndex = 0;
        function modules_changeBackground() {
            var slider = document.querySelector(".slider");
            var img = document.createElement("img");
            img.src = modules_images[currentIndex].src;
            img.alt = modules_images[currentIndex].title;
            img.style.width = "100%";
            img.style.height = "100%";
            img.style.objectFit = "cover";
            slider.innerHTML = "";
            slider.appendChild(img);
            currentIndex = (currentIndex + 1) % modules_images.length;
        }
        if (window.location.pathname === "/index.html") setInterval(modules_changeBackground, 5e3);
        function isWebp() {
        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 100, offsetTop = 0) => {
...
***************************************************************************** */
        ...
        document.addEventListener("scroll", (function() {
            ...
            if (window.scrollY > 450) headerActions.classList.add("show"); else headerActions.classList.remove("show");
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const items = document.querySelectorAll(".vue-accordion li");
            items.forEach((item => {
            ...
            const hammer = new Hammer(document.querySelector(".vue-accordion "));
        ...
        let app_elements = document.querySelectorAll(".element-animation");
        for (let elm of app_elements) observer.observe(elm);
        document.addEventListener("DOMContentLoaded", (function() {
            changeBackground();
        }));
        document.addEventListener("DOMContentLoaded", (function() {
